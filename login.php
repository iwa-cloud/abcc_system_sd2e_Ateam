                ...
                <form action="logincheck.php" method="post" style="text-align: center;">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-floating">
                                <input type="text" class="form-control" pattern=".+\.[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9]" value="" required name="mail" inputmode="numeric" minlength="0" maxlength="40">
                    ...
                    <div class="row">
                        <div class="col-md-12 mt-2">
                            <div class="form-floating">
                                <input type="password" class="form-control" pattern="^[0-9A-Za-z]+$" value="" required name="pas" inputmode="numeric" minlength="0" maxlength="20">
