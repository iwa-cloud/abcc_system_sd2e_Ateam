...
<body>
    ...
    <nav class="navbar navbar-expand navbar-dark" style="background: #232f3e;" aria-label="2 番目のナビゲーション バーの例">
        <div class="container-fluid">
          <img src="img/ロゴ.png"  width="80" height="30" class="img-fluid">
      ...
      <div class = "box">
        ...
        <div class="btn">
            <button class="btn btn-warning btn-lg text-dark" type="button" onclick="location.href='../商品一覧試作/商品一覧試作.html'">次へ</button>
        </div>
     </div>
