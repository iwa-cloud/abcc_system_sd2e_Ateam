    ...
    <nav class="navbar navbar-expand navbar-dark" style="background: #232f3e;" aria-label="2 番目のナビゲーション バーの例">
      ...
      <div class="row">
        ...
        <div class="col-4">
          <div class="card">
            <a href="https://www.youtube.com/">
              <img class="card-img-top" src="../img/ゲーミングキーボード2.png">
              <div class="card-body">
        ...
        <div class="col-4">
         <div class="card">
          <a href="https://www.youtube.com/">
            <img class="card-img-top" src="../img/ゲーミングキーボード3.png">
            <div class="card-body">
        ...
        <div class="col-4">
         <div class="card">
          <a href="https://www.youtube.com/">
            <img class="card-img-top" src="../img/ゲーミングヘッドフォン2.png">
            <div class="card-body">
        ...
        <div class="col-4">
         <div class="card">
          <a href="https://www.youtube.com/">
            <img class="card-img-top" src="../img/ゲーミングヘッドフォン3.png">
            <div class="card-body">
        ...
        <div class="col-4">
         ...
         <div class="col-4">
          <div class="card">
           <a href="https://www.youtube.com/">
             <img class="card-img-top" src="../img/ゲーミングマウス2.png">
             <div class="card-body">
         ...
         <div class="col-4">
          <div class="card">
           <a href="https://www.youtube.com/">
             <img class="card-img-top" src="../img/ゲーミングマウス3.png">
             <div class="card-body">
